...
async function addTeacher() {
  ...
  try {
    const r = await api.addTeacher({ username: U.username, parol: U.parol,
...
async function saveEdit() {
  ...
  try {
    const r = await api.editTeacher({ username: U.username, parol: U.parol,
...
async function delTeacher(idx) {
  const t = T[idx];
  try {
    const r = await api.deleteTeacher({ username: U.username, parol: U.parol,
